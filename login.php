...
function handleLogin() {
    ...
    try {
        ...
        // Get user
        $sql = "SELECT u.*, 
                (SELECT COUNT(*) FROM memberships m WHERE m.user_id = u.user_id AND m.status = 'Active') as club_count
                FROM users u 
        ...
        // Fetch memberships
        $sql = "
            SELECT m.*, c.club_name, c.club_code, c.logo
            FROM memberships m
...
<head>
    ...
    <style>
       /* =========================================================
   ClubSphere Authentication Page Styles
   ========================================================= */
...
.btn-primary:hover {
    ...
    box-shadow: 0 6px 20px rgba(255, 207, 112, 0.25);
}
            ...
            <div id="registerForm" class="form-content">
                <form method="POST" onsubmit="return validateRegisterForm()">
                    ...
                    <div class="form-check">
                        ...
                        <label>I agree to <a href="terms.php" target="_blank">Terms</a> and <a href="privacy.php" target="_blank">Privacy</a></label>
                    </div>
